...
public class EpsilonRem {
    ...
    public EpsilonRem (String[] Vn, String[] Vt, HashMap<String, HashSet<String>> productions) {
        this.Vn = Vn;
        this.Vt = Vt;
    ...
    public void nextState () {
        ...
        UnitProdRem unit= new UnitProdRem(Vn,Vt,productions);
    }
