...
public class NonProdRem {
    ...
    public NonProdRem(String[] Vn, String[] Vt, HashMap<String, HashSet<String>> productions){
        ...
        InaccesElim inaccessibleElimination= new InaccesElim(Vn,Vt,productions);
